...
function $(expression, context) 
{
    ...
    /// <param name="context">jQuery</param>
    /// <returns type="jQuery">jQuery</returns>
}

function addNumbers(a, b) 
{
    /// <summary>Add a couple of numbers</summary>
    /// <param name="a" type="Integer"></param>
    /// <param name="b" type="Integer"></param>
    /// <returns type="number">Integer</returns>
}

var x = addNumbers(1, 2);
var y = addNumbers(3, 4);
